...
echo "  1. Edit .env and set BOT_MODE: telegram | whatsapp | slack | all"
echo ""
echo "  Telegram setup:"
...
echo "    - Set WHATSAPP_ALLOWED_NUMBERS to your number (without +)"
echo "      e.g. WHATSAPP_ALLOWED_NUMBERS=919876543210"
echo "      Tip: send !id to the bot to discover your number"
echo ""
echo "  Slack setup (Socket Mode):"
echo "    - Create app at https://api.slack.com/apps"
echo "    - Set SLACK_BOT_TOKEN and SLACK_APP_TOKEN in .env"
echo ""
